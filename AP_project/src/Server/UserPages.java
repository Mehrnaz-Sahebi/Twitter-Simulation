...
public interface UserPages {
    ...
    public SocketModel signInPage(String userName, String password);//sign in and sign up should be shown, if the sign up is successful, then the home page is the same.
